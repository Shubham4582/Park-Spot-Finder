...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <span class="d-none d-md-block  ps-2"><?php 
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="parking_area.php">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="parking_details.php">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" href="add_slot.php">
     ...
     <!-- End Contact Page Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="slot_details.php">
